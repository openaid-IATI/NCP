/**
 * Authentication
 * @namepsace ncs.authentication.services
 */
(function () {
    'use strict';
    ...
    function Authentication($state, $cookies, $http, Snackbar) {
        ...
        * @returns {Promise}
        * @memberOf ncs.authentication.services.Authentication
        */
        ...
        * @desc Log "Registration failed" to the console
        */
        ...
        function logout() {
            ...
            /**
             * @name logoutErrorFn
             * @desc Log "Log out failed" to the console
             */

...
function set_styles(back, front, position) {
  ...
  back.style.top = $(front).offset().top + "px"
  var padding_left = $(front).css("padding-left").replace("px", "");
  var left = parseInt(padding_left) + $(front).offset().left;
  back.style.left = left + "px"
  back.style['min-height'] = front.offsetHeight + "px"
  back.style.width = $(front).width() + "px"
  back.style["z-index"] = 10
}
